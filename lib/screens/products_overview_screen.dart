...
import 'package:shopin/models/product.dart';
import 'package:shopin/widgets/product_item_widget.dart';
...
final List<Product> loadedProducts = [
  ...
  Product(
    id: 'p3',
    title: 'Pixel 8 Pro',
    description: 'The best Camera phone in the world, powered by Tensor G3 chip, it houses a lot of AI features, it has Clean Stock Android',
    price: 19.99,
  ...
  Product(
    id: 'p4',
    title: 'OnePlus 12',
    description: 'The value for money smartphone in the world, powered by Snapdragon 8 Gen 3 chip, it provides best overall package with good display, camera & performance',
    price: 49.99,
